  ...
  navegacionLogin() {
    ...
    if (!this.ionicForm.valid) {
      ...
      switch (this.tipoUsuario) {
        case 'Consumidor':
          this.loginService
            .autentification(this.cedula, this.contrasena, this.tipoUsuario)
            .subscribe(
              (val) => {
        ...
        case 'Agricultora':
          this.loginService
            .autentification(this.cedula, this.contrasena, this.tipoAgricultora)
            .subscribe(
              (val) => {
        ...
        case 'Conductor':
          this.loginService
            .autentification(this.cedula, this.contrasena, this.tipoConductor)
            .subscribe(
              (val) => {
